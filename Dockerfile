...
RUN apt-get install --no-install-recommends -y autoconf automake autopoint autotools-dev bsdmainutils build-essential cmake cmake-data cpp cpp-8 dbus dbus-user-session dconf-gsettings-backend dconf-service debhelper default-libmysqlclient-dev dh-autoreconf dh-python dh-strip-nondeterminism \
  ...
  libdbus-1-3 libdbus-1-dev libdbus-glib-1-2 libdbus-glib-1-dev libdbus-glib-1-dev-bin libdconf1 libdevmapper1.02.1 libdouble-conversion1 libdrm-amdgpu1 libdrm-common libdrm-dev libdrm-intel1 libdrm-nouveau2 libdrm-radeon1 libdrm2 libedit2 libegl-mesa0 \
  libegl1 libev-dev libev-libevent-dev libev4 libevdev2 libevent-2.1-6 libevent-core-2.1-6 libevent-pthreads-2.1-6 libexpat1-dev libfabric1 libfarstream-0.2-5 libffi-dev libfile-stripnondeterminism-perl libfontconfig1 libfreetype6 libgadu3 libgbm1 \
  ...
  libharfbuzz0b libhwloc-dev libhwloc-plugins libhwloc5 libibverbs-dev libibverbs1 libice6 libicu-dev libicu63 libidn11 libidn11-dev libidn2-dev libinput-bin libinput10 libip4tc0 libisl19 libitm1 libjpeg62-turbo libjson-c3 libjsoncpp-dev libjsoncpp1 \
  libkmod2 libldap2-dev libllvm7 liblog4cxx-dev liblog4cxx10v5 liblsan0 libltdl-dev libltdl7 libmariadb-dev libmariadb-dev-compat libmariadb3 libmeanwhile1 libminiupnpc17 libmount-dev libmpc3 libmpfr6 libmpx2 libmtdev1 libnatpmp1 libncurses6 libnice10 \
  ...
  libpcrecpp0v5 libpipeline1 libpmix2 libpng16-16 libpopt-dev libpopt0 libpq-dev libpq5 libpqxx-6.2 libpqxx-dev libprocps7 libprotobuf-c1 libprotobuf-dev libprotobuf-lite17 libprotobuf17 libprotoc17 libproxy1v5 libpsm-infinipath1 libpsm2-2 \
  ...
  libqt5core5a libqt5dbus5 libqt5gui5 libqt5network5 libqt5printsupport5 libqt5qml5 libqt5sql5 libqt5test5 libqt5widgets5 libqt5xml5 libquadmath0 librdmacm1 librhash0 libsasl2-modules libsctp-dev libsctp1 libselinux1-dev libsensors-config libsensors5 \
  libsepol1-dev libsigsegv2 libsm6 libsoup2.4-1 libsqlite3-dev libstdc++-8-dev libtasn1-6-dev libtool libtsan0 libubsan1 libuchardet0 libunbound8 libuv1 libvulkan-dev libvulkan1 libwacom-common libwacom2 libwayland-client0 \
...
RUN apt-get install --no-install-recommends -y autoconf automake autopoint autotools-dev bsdmainutils build-essential cpp cpp-8 debhelper dh-autoreconf dh-strip-nondeterminism dwz g++ g++-8 gcc gcc-8 gettext gettext-base groff-base intltool-debian libarchive-zip-perl libasan5 libatomic1 \
  libc-dev-bin libc6-dev libcc1-0 libcroco3 libdouble-conversion1 libevdev2 libfile-stripnondeterminism-perl libgcc-8-dev libgomp1 libgraphite2-3 libgudev-1.0-0 libharfbuzz0b libinput-bin libinput10 libisl19 libitm1 liblsan0 libmpc3 libmpfr6 libmpx2 \
  ...
  libqt5widgets5 libqt5xml5 libquadmath0 libsigsegv2 libstdc++-8-dev libtool libtsan0 libubsan1 libuchardet0 libvulkan-dev libvulkan1 libwacom-common libwacom2 libxcb-icccm4 libxcb-image0 libxcb-keysyms1 libxcb-render-util0 libxcb-shm0 libxcb-util0 \
